...
export const mockVenueTransactions: MockVenueTransaction[] = [
  ...
  },
  {
    ...
    realizedPnl: 452.6,
    orderId: 'cb-5638291',
    externalRef: 'coinbase:5638291',
    source: 'manual_sync',
    initiatedBy: 'external',
    venueAccountId: 'coinbase-primary',
    tradePair: 'ETH/USD',
    venueTimestamp: '2025-01-12T14:32:00Z',
    settledAt: '2025-01-12T14:32:04Z',
    ...
    taxLotRef: 'lot-2024-0112',
    notes: 'Manual sale synced from Coinbase account.'
  },
  {
    id: 'txn-2025-0003',
    venue: 'Binance',
    ...
    feeAsset: 'USDT',
    netValue: 32250,
    externalRef: 'wallet:bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh',
    source: 'manual_sync',
    initiatedBy: 'external',
    venueAccountId: 'binance-primary',
    walletAddress: 'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh',
    tradePair: 'BTC/USDT',
    venueTimestamp: '2025-01-18T08:10:00Z',
    settledAt: '2025-01-18T08:30:00Z',
    createdAt: '2025-01-18T08:30:05Z',
    updatedAt: '2025-01-18T08:30:05Z',
    quoteConversion: {
      currency: 'CHF',
      rate: 0.89,
      value: 28702.5
    },
    taxLotRef: 'lot-transfer-2025-01',
    notes: 'Inbound transfer from self-custody wallet for consolidation.'
  },
  {
    id: 'txn-2025-0004',
    venue: 'SDX',
    ...
    tradePair: 'DOT/CHF',
    venueTimestamp: '2025-01-20T18:00:00Z',
    settledAt: '2025-01-20T18:05:00Z',
    createdAt: '2025-01-20T18:05:10Z',
    updatedAt: '2025-01-20T18:05:10Z',
    quoteConversion: {
      currency: 'CHF',
      rate: 1,
      value: 100.98
    },
    taxLotRef: 'income-2025-0004',
  ...
  },
  {
    ...
    netValue: 4975,
    realizedPnl: 0,
    orderId: 'withdraw-77831',
    externalRef: 'coinbase:withdraw:77831',
    source: 'imported_csv',
    initiatedBy: 'manual',
    venueAccountId: 'coinbase-fiat',
    tradePair: 'USD/USD',
    venueTimestamp: '2025-01-22T12:00:00Z',
    settledAt: '2025-01-22T12:01:00Z',
    createdAt: '2025-01-22T12:05:00Z',
    updatedAt: '2025-01-22T12:05:00Z',
    quoteConversion: {
      currency: 'CHF',
      rate: 0.89,
      value: 4427.75
    },
    notes: 'Withdrawal to external bank account recorded via CSV import.'
  }
];
...
export const mockFxRates: MockFxRate[] = [
  ...
  {
    id: 'fx-usd-chf-2025-01-12',
    baseCurrency: 'USD',
    quoteCurrency: 'CHF',
    rate: 0.91,
    capturedAt: '2025-01-12T00:00:00Z',
    source: 'MockFXFeed'
  },
  {
    id: 'fx-eur-chf-2025-01-31',
    baseCurrency: 'EUR',
    quoteCurrency: 'CHF',
    rate: 0.97,
    capturedAt: '2025-01-31T00:00:00Z',
    source: 'MockFXFeed'
  }
];
...
export const mockMarketPrices: MockMarketPrice[] = [
  ...
  {
    id: 'price-eth-usd-2025-01-12',
    venue: 'Coinbase',
    symbol: 'ETH/USD',
    price: 3215,
    currency: 'USD',
    capturedAt: '2025-01-12T14:30:00Z',
    source: 'Coinbase'
  },
  {
    id: 'price-dot-chf-2025-01-20',
    venue: 'SDX',
    symbol: 'DOT/CHF',
    price: 6.8,
    currency: 'CHF',
    capturedAt: '2025-01-20T18:00:00Z',
    source: 'SDX'
  }
];
